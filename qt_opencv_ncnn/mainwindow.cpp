    ...
    , ui(new Ui::MainWindow)
{
    ...
    ui->graphicsView->setScene(new QGraphicsScene(this));
    ui->graphicsView->scene()->addItem(&pixmap);
    ui->centralwidget->setObjectName("central");
    ui->centralwidget->setStyleSheet("#central{background-color:qlineargradient"
       "(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 #35A46C,stop:0.5 #29CEB9,stop:1 #35A49D)}");
    this->resize(635,445);
}
...
void MainWindow::on_pushButton_pressed()
{
    ...
    //初始化facenet
    const char *model_path = "/home/lbr/last_qt_opencv_ncnn/Qt_ncnn_opencv-main/qt_opencv_ncnn/models";
    Recognize recognize(model_path);
    sampleimg = cv::imread("/home/lbr/last_qt_opencv_ncnn/Qt_ncnn_opencv-main/qt_opencv_ncnn/sample.jpg", CV_LOAD_IMAGE_COLOR);
...
void MainWindow::on_brobtn_clicked()
{
    BrowseWidget * brbtn = new BrowseWidget();
    QString fileFull;
    fileFull = QFileDialog::getOpenFileName(brbtn,tr("file list"),"/");

    this->ui->videoEdit->setText(fileFull);
    brbtn->setAttribute(Qt::WA_DeleteOnClose);// Preventing Memory leaks
